	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			//코드 검색
				...
				Product p = pm.searchByCode(sc.next());
				if(p != null) {
			...
			//기초 데이터 등록
				...
				pm.addProduct(new SmartPhone("phone1","galaxyS10",1200000,100));
				pm.addProduct(new SmartPhone("phone2","galaxyNote10",1400000,100));
				pm.addProduct(new SmartPhone("phone3","V50",1300000,1000));
			//종료
			}else if(num == 0){
